...
let serviceUrl = urlConfig.serviceUrl ? urlConfig.serviceUrl : document.domain.replace(/^w{3}\./i, '').replace(/^/i, 'service.').replace(/:\d+$/i, '');
let cookieDomainRange = document.domain.replace(/^w{3}\./i,'').replace(/^/i, '.').replace(/:\d+$/i, '');
