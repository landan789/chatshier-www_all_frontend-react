                ...
                <Row>
                    <Col className="small-features">
                        <div className="small-feature">
                            <div className="icon"><img src="../../../assets/images/icons/home-message.svg"/></div>
                        ...
                        <div className="small-feature">
                            <div className="icon" onScroll={props.onScroll}><img src="../../../assets/images/icons/home-thought.svg"/></div>
                            <div className="small-feature__text">
                                <h5>聊天機器人Chatbot</h5>
                        ...
                        <div className="small-feature">
                            <div className="icon" onScroll={props.onScroll}><img src="../../../assets/images/icons/home-projection.svg"/></div>
                            <div className="small-feature__text">
                                <h5>數據驅動客服策略</h5>
